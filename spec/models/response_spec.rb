...
RSpec.describe Response, type: :model do
  ...
  context 'associations' do
    it { should belong_to(:innovation_topic).optional }
    it { should belong_to(:innovation_brainstorming).optional }
  ...
  context 'validations' do
    ...
    it 'when innovation_topic is absent' do
      response.innovation_topic = nil
      expect(response).to be_valid
    end

    it 'when innovation_brainstorming is absent' do
      response.innovation_brainstorming = nil
      expect(response).to be_valid
    end

    it 'allows creation without innovation_topic or innovation_brainstorming' do
      response = build(:response, innovation_topic: nil, innovation_brainstorming: nil)
      expect(response).to be_valid
    end
  end
