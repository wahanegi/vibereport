...
const InnovationBrainstorming = ({
  ...
  const {user_name, innovation_body} = data.innovation_topic;
  ...
  const handleSaveDraft = () => {
    const dataFromServer = (innovation_brainstorming) => {
      ...
      saveDataToDb(steps, {
        innovation_brainstorming_id: id, //todo
      });
    };
        ...
        <div className="container-fluid w-100 pt-1 pt-md-0">
          ...
          <div className="mb-4">
            <div
              ...
              {user && (
                <p className="fs-8 fs-md-7 text-gray-600 lh-lg"> {user} asks what do you think about: </p>
              )}
              <div id="topic" className='text-start fs-7 fs-md-6 mb-1'>{innovation_body}</div>
              <div className="w-100">
