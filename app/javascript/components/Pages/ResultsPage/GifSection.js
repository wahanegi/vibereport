...
const PreviewGifSection = () => (
  <div className="col-12 col-xxl-9 col-xl-9 col-lg-9 col-md-10 col-sm-12 blur-effect">
...
const GifSection = ({ gifs, nextTimePeriod, isMinUsersResponses, loaded }) => {
  ...
  return <div className="col-12 col-xxl-9 col-xl-9 col-lg-9 col-md-10 col-sm-12 mb-3">
    <div
      className="row row-cols-xxl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 align-items-center justify-content-center">
      {gifItems}
    </div>
