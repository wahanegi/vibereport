module ActiveAdminHelpers
  def time_period_vars(team, time_period, previous_time_period, all_time_period, current_period)
    ...
    vars[:previous_emotion_index] =
      EmotionIndex.new(team, previous_time_period).generate if previous_time_period
    ...
    vars[:previous_productivity_avg] =
      ProductivityAverage.new(team, previous_time_period).generate if previous_time_period
    ...
    vars[:previous_participation_percentage] =
      ParticipationPercentage.new(team, previous_time_period).generate if previous_time_period
    ...
    vars[:previous_celebrate_comments_count] =
      CelebrationsCount.new(team, previous_time_period).generate if previous_time_period
    ...
    vars[:previous_teammate_engagement_count] =
      TeammateEngagementCount.new(team, previous_time_period).generate if previous_time_period
