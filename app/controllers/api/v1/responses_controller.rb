  ...
  module V1
    class ResponsesController < ApplicationController
      PARAMS_ATTRS = [:user_id, :emotion_id, :time_period_id, [steps: []], :not_working, :notices, :rating,
                      ...
                      :fun_question_answer_id, :completed_at, :draft, :celebrate_comment, :ai_question, :ai_answer,
                      { gif: %i[src height] }, :innovation_brainstorming_id, :innovation_topic_id].freeze
